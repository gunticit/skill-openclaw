...
- See `Antigravity-Production-Grade-Suite/.protocols/conflict-resolution.md`
...
- Write workspace artifacts to: Antigravity-Production-Grade-Suite/devops/
...
Context:
- Read HARDEN findings from workspace: Antigravity-Production-Grade-Suite/security-engineer/, code-reviewer/, qa-engineer/
...
- Write workspace artifacts to: Antigravity-Production-Grade-Suite/sre/
...
- Write workspace artifacts to: Antigravity-Production-Grade-Suite/data-scientist/
